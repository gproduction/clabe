...
module Clabe
  ...
  BANKS = {
    '001' => { tag: 'BANXICO',               name: 'Banco de México' },
    ...
    '012' => { tag: 'BBVA MEXICO',           name: 'BBVA México, S.A.' },
    ...
    '030' => { tag: 'BAJIO',                 name: 'Banco del Bajío, S.A.' },
    ...
    '108' => { tag: 'MUFG',                  name: 'MUFG Bank México, S.A' },
    ...
    '132' => { tag: 'MULTIVA BANCO',         name: 'Banco Multiva, S.A.' },
    ...
    '154' => { tag: 'BANCO COVALTO',         name: 'Banco Covalto, S.A., Institución De Banca Múltiple' },
    ...
    '159' => { tag: 'BANK OF CHINA',         name: 'Bank Of China' },
    '160' => { tag: 'BANCO S3',              name: 'Banco S3 México, S.A.' },
    '166' => { tag: 'BABIEN',                name: 'Banco Del Bienestar, Sociedad Nacional De Crédito, Institución De Banca De Desarrollo' },
    ...
    '613' => { tag: 'MULTIVA CBOLSA',        name: 'Casa De Bolsa Multiva, S.A. DE C.V' },
    ...
    '638' => { tag: 'NU MEXICO',             name: 'NU Mexico Financiera, S.A. DE C.V., S.F.P.' },
    ...
    '648' => { tag: 'TACTIV CB',             name: 'TACTIV Casa de Bolsa, S.A. de C.V.' },
    ...
    '661' => { tag: 'ALTERNATIVOS',          name: 'Servicios financieros alternativos, S.A. DE C.V., S.F.P.' },
    ...
    '684' => { tag: 'OPM',                   name: 'Operadora de Pagos Moviles de Mexico, S.A. de C.V.' },
    ...
    '688' => { tag: 'CREDICLUB',             name: 'CREDICLUB, S.A. DE C.V., S.F.P.' },
    '689' => { tag: 'FOMPED',                name: 'Fondo Mexicano del Petroleo para la Estabilizacion y el Desarrollo' },
    '703' => { tag: 'TESORED',               name: 'Tesored, S.A. De C.V.' },
    '706' => { tag: 'ARCUS',                 name: 'Arcus F.I., S.A. DE C.V.' },
    '710' => { tag: 'NVIO',                  name: 'NVIO Pagos México, S.A.P.I. de C.V' },
  ...
  CITIES = [
    ['010', "Aguascalientes MX-AGU"],
    ['011', "Asientos MX-AGU"],
    ['012', "Calvillo MX-AGU"],
    ['013', "Cosio MX-AGU"],
    ['014', "Jesús María MX-AGU"],
    ['015', "Pabellon de Arteaga MX-AGU"],
    ['016', "Rincon de Romos MX-AGU"],
    ['017', "San Fco Romo MX-AGU"],
    ['020', "Mexicali MX-BCN"],
    ['021', "Ciudad Morelos MX-BCN"],
    ['022', "Ensenada MX-BCN"],
    ['023', "Guadalupe Victoria MX-BCN"],
    ['024', "Rodolfo Sanchez T. MX-BCN"],
    ['025', "San Felipe MX-BCN"],
    ['026', "San Quintin MX-BCN"],
    ['027', "Tecate MX-BCN"],
    ['027', "Tijuana"],
    ['028', "La Mesa"],
    ...
    ['043', "Guerrero Negro MX-BCS"],
    ['044', "Loreto MX-BCS"],
    ['045', "San José del Cabo MX-BCS"],
    ['046', "Santa Rosalía MX-BCS"],
    ['047', "Todos Santos MX-BCS"],
    ['050', "Campeche MX-CAM"],
    ['051', "Calkiní MX-CAM"],
    ['052', "Ciudad del Carmen MX-CAM"],
    ['053', "Champotón MX-CAM"],
    ['054', "Escarcega MX-CAM"],
    ['055', "Hopelchen MX-CAM"],
    ['056', "Palizada MX-CAM"],
    ['057', "Seybaplaya MX-CAM"],
    ['060', "Gómez Palacio"],
    ['060', "Torreón MX-COA"],
    ['061', "Abasolo MX-COA"],
    ['062', "Acuña MX-COA"],
    ['062', "Ciudad Acuña"],
    ['063', "Allende MX-COA"],
    ['064', "Francisco I. Madero MX-COA"],
    ['065', "Frontera MX-COA"],
    ['066', "Laguna del Rey MX-COA"],
    ['067', "Matamoros MX-COA"],
    ['068', "Monclova MX-COA"],
    ['069', "Morelos MX-COA"],
    ['070', "Muzquiz MX-COA"],
    ['071', "Nava MX-COA"],
    ['072', "Nueva Rosita"],
    ['072', "Nva Rosita MX-COA"],
    ['073', "Palau MX-COA"],
    ['074', "Parras de la Fuente MX-COA"],
    ['075', "Piedras Negras MX-COA"],
    ['076', "Ramos Arizpe MX-COA"],
    ['077', "Sabinas MX-COA"],
    ['078', "Saltillo MX-COA"],
    ['079', "San Buenaventura MX-COA"],
    ['080', "San Pedro de las Colonias MX-COA"],
    ['081', "Zaragoza MX-COA"],
    ['090', "Colima MX-COL"],
    ['091', "Armeria MX-COL"],
    ['092', "Comala MX-COL"],
    ['093', "Coquimatlan MX-COL"],
    ['094', "Cuauhtemoc MX-COL"],
    ['095', "Manzanillo MX-COL"],
    ['096', "Queseria MX-COL"],
    ['097', "Tecomán MX-COL"],
  ...
  ].group_by(&:shift).transform_values(&:flatten).freeze
  ...
  def self.validate(clabe)
    ...
    if clabe_params[:city].nil? || clabe_params[:city].size == 0
    ...
    clabe_validation[:city] = clabe_params[:city]&.join(', ')
    return clabe_validation
  end
end
